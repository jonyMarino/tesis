...
src-gen/Aplicacion/%.o: ../src-gen/Aplicacion/%.c
	...
	gcc -std=c99 -I"/home/marino/workspace_tesis/tesis/ejemplos_de_codificacion_para_cada_framework/OOC_Tibor_Miseta/src-gen" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
