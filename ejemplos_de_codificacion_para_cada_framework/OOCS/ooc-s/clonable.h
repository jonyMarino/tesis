...
#define TYPE      struct clonable
#define INTERFACE struct clonable_interface

#define CLONABLE_INTERFACE      \
   TYPE* (*clone)(TYPE*);
...
extern INTERFACE clonable_interface;
