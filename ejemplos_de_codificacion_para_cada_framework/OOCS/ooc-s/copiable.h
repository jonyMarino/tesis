...
#define TYPE      struct copiable
#define INTERFACE struct copiable_interface

#define COPIABLE_INTERFACE      \
   TYPE* (*copy)(TYPE*,TYPE*);  \
   TYPE* (*swap)(TYPE*,TYPE*);
...
extern INTERFACE copiable_interface;
