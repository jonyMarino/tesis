#if !defined(OOC99_H) || defined(IMPLEMENTATION)
#define OOC99_H
...
#ifndef __STDC__
#  error "ooc99.h needs ISO C compiler to work properly"
#endif
...
#  define classMethod(fct) \
          (*fct)(void)
#  define classMethod_(fct, args) \
          (*fct)(_getprm_ args)

#  define method(fct) \
          (*fct) (t_OBJECT *const)
#  define method_(fct, args) \
          (*fct) (t_OBJECT *const, _getprm_ args)
#  define constMethod(fct) \
          (*fct) (t_OBJECT const*const)
#  define constMethod_(fct, args) \
          (*fct) (t_OBJECT const*const, _getprm_ args)
...
#  define classMethodDecl_(fct, args) \
   static methodName(fct)(_getprm_ args)

#  define methodDecl(fct) \
   static methodName(fct)(t_OBJECT *const this)
#  define methodDecl_(fct, args) \
   static methodName(fct)(t_OBJECT *const this, _getprm_ args)
#  define constMethodDecl(fct) \
   static methodName(fct)(t_OBJECT const*const this)
#  define constMethodDecl_(fct, args) \
   static methodName(fct)(t_OBJECT const*const this, _getprm_ args)

#  define methodOvldDecl(fct, obj) \
   static methodOvldName(fct,obj)(_concat_(t_,obj) *const this)
#  define methodOvldDecl_(fct, obj, args) \
   static methodOvldName(fct,obj)(_concat_(t_,obj) *const this, _getprm_ args)
#  define constMethodOvldDecl(fct, obj) \
   static methodOvldName(fct,obj)(_concat_(t_,obj) const*const this)
#  define constMethodOvldDecl_(fct, obj, args) \
   static methodOvldName(fct,obj)(_concat_(t_,obj) const*const this, _getprm_ args)
...
#  define classMethod(fct) \
          (*const fct)(void)
#  define classMethod_(fct, args) \
          (*const fct)(_getprm_ args)

#  define method(fct) \
          (*const fct) (t_OBJECT *const)
#  define method_(fct, args) \
          (*const fct) (t_OBJECT *const, _getprm_ args)
#  define constMethod(fct) \
          (*const fct) (t_OBJECT const*const)
#  define constMethod_(fct, args) \
          (*const fct) (t_OBJECT const*const, _getprm_ args)
#endif
...
#define sendMsg(obj, msg) \
        ((obj)->__vptr->msg)(obj)
#define sendMsg_(obj, msg, args) \
        ((obj)->__vptr->msg)(obj, _getprm_ args)

/* class messages */
#define sendCMsg(obj, class, msg) \
        ((class).__vptr->msg)(obj)
#define sendCMsg_(obj, class, msg, args) \
        ((class).__vptr->msg)(obj, _getprm_ args)
